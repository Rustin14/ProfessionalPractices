...
public class PrincipalWindowProfessor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelIcongenerateActivitie.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Ventanas/Imagenes/GEnerateActivitie.png"))); // NOI18N
        getContentPane().add(jLabelIcongenerateActivitie, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 110, -1, -1));

        jLabelActivitiesDeliveredICon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Ventanas/Imagenes/ActivitiesDelivered.png"))); // NOI18N
        getContentPane().add(jLabelActivitiesDeliveredICon, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 200, -1, -1));

        jLabelReportMontlyIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Ventanas/Imagenes/reportMontlyIcon.png"))); // NOI18N
        getContentPane().add(jLabelReportMontlyIcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 140, -1, -1));

        jLabelUploadPresentationFormatIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Ventanas/Imagenes/uploadFormatPresentationIcon.png"))); // NOI18N
        getContentPane().add(jLabelUploadPresentationFormatIcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 280, -1, -1));

        jLabelPartialReportIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Ventanas/Imagenes/reportParcialIcon.png"))); // NOI18N
