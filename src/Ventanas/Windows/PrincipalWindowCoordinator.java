...
public class PrincipalWindowCoordinator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelRegisterProyectIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Ventanas/Imagenes/RegisterProyectIcon.png"))); // NOI18N
        getContentPane().add(jLabelRegisterProyectIcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 60, -1, -1));

        jLabelAssignProyectIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Ventanas/Imagenes/assignIcon.png"))); // NOI18N
        getContentPane().add(jLabelAssignProyectIcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 150, -1, -1));

        jLabelUpdateProyectIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Ventanas/Imagenes/updateIcon.png"))); // NOI18N
        getContentPane().add(jLabelUpdateProyectIcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 230, -1, -1));

        jLabelDeletePRoyectIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Ventanas/Imagenes/DeleteIcon.png"))); // NOI18N
        getContentPane().add(jLabelDeletePRoyectIcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 310, -1, -1));

        jLabelRegisterPracticingIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Ventanas/Imagenes/RegisterPracticingIcon.png"))); // NOI18N
        getContentPane().add(jLabelRegisterPracticingIcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 90, -1, -1));

        jLabelDeleteIconPRacticing.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Ventanas/Imagenes/DeletePRacticingIcon.png"))); // NOI18N
        getContentPane().add(jLabelDeleteIconPRacticing, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 190, -1, -1));

        jLabelGeneratrReportIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Ventanas/Imagenes/GEnerateReportIcon.png"))); // NOI18N
